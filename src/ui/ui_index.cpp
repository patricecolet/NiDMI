...
<div class="f" style="display:none;"><label>Pin SIG (analogique):</label><select id="muxSig"></select></div>
<div class="f"><label>Pin S0:</label><select id="muxS0"></select></div>
<div class="f"><label>Pin S1:</label><select id="muxS1"></select></div>
<div class="f"><label>Pin S2:</label><select id="muxS2"></select></div>
<div class="f"><label>Pin S3:</label><select id="muxS3"></select></div>
<div class="f"><label>Pin EN (optionnel):</label><select id="muxEnManual"><option value="255">Non connecte</option></select></div>
<h4 style="margin-top:20px;">Configuration analogique</h4>
 ...
 <div class="hint">Adresses OSC pour le calibrage: /mux[ID]/cal/min [CH] /mux[ID]/cal/max [CH] /mux[ID]/cal/reset [CH] (CH=0-15)</div>
