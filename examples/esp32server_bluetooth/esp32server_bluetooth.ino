/*
 * Exemple ESP32Server avec Bluetooth MIDI
 * 
 * Ce sketch démontre l'utilisation du Bluetooth MIDI avec ESP32Server.
 * 
 * Fonctionnalités :
 * - Bluetooth MIDI automatiquement activé
 * - Boutons et potentiomètres routés vers Bluetooth
...
void setup() {
    Serial.begin(115200);
    Serial.println("\n=== ESP32Server Bluetooth MIDI ===");
    
    // Initialiser ESP32Server (Bluetooth activé automatiquement)
    esp32server_setup();
...
void loop() {
    ...
    // Le Bluetooth MIDI est géré automatiquement
}
