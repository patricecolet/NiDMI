/*
 * Exemple ESP32Server avec BLE simple
 * 
 * Ce sketch démontre une communication BLE simple avec ESP32Server.
 * Inspiré de l'exemple BLE basique d'Arduino.
 * 
 * Pour activer BLE, ajoutez cette ligne au début du fichier :
 ...
 * - Utiliser avec des apps de terminal Bluetooth
 * 
 * Matériel :
...
void setup() {
    ...
    Serial.println("Utilisez une app de terminal Bluetooth pour communiquer");
}
...
void loop() {
    ...
    // Le BLE est géré automatiquement
}
