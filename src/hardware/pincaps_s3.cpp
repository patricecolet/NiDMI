...
const char PINCAPS_S3[] PROGMEM = R"JSON({
  ...
  "pins":[
    ...
    {"gpio":7,  "label":"D6", "caps":{"in":true,"out":true,"adc":false,"pwm":true,"touch":false}, "sensitive":false},
    {"gpio":8,  "label":"D7", "caps":{"in":true,"out":true,"adc":false,"pwm":true,"touch":false}, "sensitive":false},
