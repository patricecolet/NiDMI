...
<body>
 ...
 <div class="t"><div class="tab active" data-t="status">Status</div><div class="tab" data-t="connection">Connection</div><div class="tab" data-t="pins">Pins</div><div class="tab" data-t="components">Components</div></div>
 ...
 <div class="g">
 <div class="card">
 <h3>Analog multiplexers</h3>
 <p>Add an HC4067 multiplexer to extend analog inputs.</p>
 <div id="muxList" class="list" style="margin:10px 0;"></div>
 <button class="btn" onclick="showMuxForm()">+ Add HC4067</button>
 </div>
 </div>
 </div>
 </div>
 ...
 <div class="f"><label><input type="checkbox" id="muxHysteresis" checked> Hysteresis enabled</label></div>
