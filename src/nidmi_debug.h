...
//   #define NIDMI_DEBUG_OSC 1        // Activer debug OSC
//   #define NIDMI_DEBUG_NETWORK 1   // Activer debug Network
//   // Pas de #define = module désactivé (zéro flash)
//
// ============================================================================

// Si aucun debug n'est défini, tout est désactivé (zéro overhead)
#ifndef NIDMI_DEBUG_OSC
#define NIDMI_DEBUG_OSC 0
#endif

#ifndef NIDMI_DEBUG_NETWORK
#define NIDMI_DEBUG_NETWORK 0
#endif

#ifndef NIDMI_DEBUG_COMPONENTS
#define NIDMI_DEBUG_COMPONENTS 0
#endif

#ifndef NIDMI_DEBUG_WEBSOCKET
#define NIDMI_DEBUG_WEBSOCKET 0
#endif

#ifndef NIDMI_DEBUG_PINS
#define NIDMI_DEBUG_PINS 0
#endif

#ifndef NIDMI_DEBUG_CACHE
#define NIDMI_DEBUG_CACHE 0
#endif

#ifndef NIDMI_DEBUG_RTPMIDI
#define NIDMI_DEBUG_RTPMIDI 0
#endif

#ifndef NIDMI_DEBUG_API
#define NIDMI_DEBUG_API 0
#endif
