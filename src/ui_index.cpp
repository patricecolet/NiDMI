 ...
 *{margin:0;padding:0;box-sizing:border-box}
 ...
 const fieldsToWatch=['funcSelect','btnMode','ledMode','potFilter','rtpEnabled2','rtpMsgType','rtpNote','rtpCc','rtpPc','rtpChan','rtpCcOn','rtpCcOff','rtpVel','rtpCcMin','rtpCcMax','rtpNoteMin','rtpNoteMax','rtpNoteVelFix','oscEnabled2','oscAddress','oscFormat','dbgEnabled','dbgHeader'];
