 ...
 *
 * Lit une valeur tactile (0-4095) qui MONTE quand on touche sur un pin touch ESP32-S3,
...
public:
    ...
    // Calibration des baselines touch
    static void resetBaseline(uint8_t gpio);
    static void resetAllBaselines();
};
